    ...
    <div className='grid grid-cols-4 gap-4 flex justify-center'>
      {projects.map((project) =>{
        return (
            ...
            <button className='p-6 max-w-sm mx-auto rounded-2xl shadow-lg flex items-center space-x-4 grid grid-cols-1 bg-gradient-to-r from-purple-400 to-blue-500 hover:from-pink-500 hover:to-yellow-500'>
