    ...
    <form className="mt-8 space-y-6" onSubmit={e => onSubmit(e)}>
      ...
      <div className="flex items-center justify-between">
        <div className="text-sm">
          <Link className="font-medium text-indigo-600 hover:text-indigo-500" to='/reset-password'>Forgot your password?</Link>
        </div>
        <div className="text-sm">
          <Link className="font-medium text-indigo-600 hover:text-indigo-500" to='/sign-up'>Don't have an account? Sign up</Link>
        </div>
      </div>
